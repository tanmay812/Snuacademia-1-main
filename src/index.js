  ...
  let erpFaqs = [
    {
      ...
      answer:
        "ERP (Enterprise Resource Planning) is a software system that integrates various business processes and functions to streamline operations and enhance efficiency.",
    },
    {
      question: "What are the benefits of implementing an ERP system?",
      answer:
        "Some of the benefits of implementing an ERP system include improved productivity, better data visibility, enhanced decision-making, streamlined processes, and cost savings.",
    },
    {
      question: "How does an ERP system work?",
      answer:
        "An ERP system works by integrating data and processes across different departments or functions within an organization, allowing for centralized data storage, real-time information sharing, and efficient collaboration.",
    },
    {
      question: "What modules are typically included in an ERP system?",
      answer:
        "Common modules in an ERP system include finance and accounting, human resources, inventory management, procurement, sales and marketing, production planning, and customer relationship management (CRM).",
    },
    {
      question: "How can ERP benefit educational institutions?",
      answer:
        "ERP systems can benefit educational institutions by automating administrative tasks, managing student records, facilitating communication, improving resource allocation, and supporting data-driven decision-making.",
    },
  ];
  let fastrackFaqs = [
    {
      ...
      answer:
        "Fastrack is a system used for applying for permission to leave the campus grounds temporarily.",
    },
    {
      question: "How do I apply for Fastrack?",
      answer:
        "To apply for Fastrack, you need to log in to the Fastrack portal, fill out the required details, and submit your application.",
    },
    {
      question: "What are the eligibility criteria for Fastrack?",
      answer:
        "The eligibility criteria for Fastrack may vary depending on the university's policies. Typically, it may include factors such as academic standing, disciplinary record, and attendance.",
    },
    {
      question: "How long does it take to get a Fastrack approval?",
      answer:
        "The time taken to receive a Fastrack approval can vary. It is recommended to submit your application well in advance to allow sufficient time for the approval process.",
    },
    {
      question: "What should I do if my Fastrack application gets rejected?",
      answer:
        "If your Fastrack application gets rejected, you can reach out to the designated authority or department to understand the reasons for rejection and seek further guidance.",
    },
  ];
  let hostelFaqs = [
    {
      ...
      answer:
        "Hostel management refers to the administration and supervision of residential facilities provided to students or individuals within an educational institution or other similar settings.",
    },
    {
      question: "How do I apply for hostel accommodation?",
      answer:
        "To apply for hostel accommodation, you typically need to fill out a hostel application form provided by your educational institution. The form will require necessary details such as personal information, preferred room type, and any specific requirements.",
    },
    {
      question: "What amenities are usually provided in hostels?",
      answer:
        "Hostels generally offer basic amenities such as beds, study desks, storage spaces, shared bathrooms, common areas, and sometimes additional facilities like recreational areas, laundry rooms, or dining halls.",
    },
    {
      question: "What are the rules and regulations in hostels?",
      answer:
        "Hostels have specific rules and regulations that residents must adhere to, including guidelines related to curfew hours, visitor policies, noise restrictions, cleanliness, safety protocols, and other aspects to ensure a conducive living environment for all residents.",
    },
    {
      question:
        "What should I do if I have issues or complaints regarding hostel facilities?",
      answer:
        "If you have any issues or complaints regarding hostel facilities, it is recommended to contact the hostel management office or the designated authority responsible for addressing such concerns. They will assist you in resolving the problem or guiding you on the necessary steps to take.",
    },
  ];
  let blackboardFaqs = [
    {
    ...
    },
    {
      ...
      answer:
        "To access Blackboard, you need to log in to your educational institution's Blackboard portal using your assigned username and password. The portal is typically accessible through a web browser or a dedicated Blackboard mobile app.",
    },
    {
      question: "What kind of materials can I find on Blackboard?",
      answer:
        "On Blackboard, professors can upload various materials such as lecture notes, slides, reading materials, videos, quizzes, discussion boards, and other course-related resources. It serves as a centralized platform for accessing and managing course content.",
    },
    {
      question: "How can I submit assignments on Blackboard?",
      answer:
        "Blackboard provides features for students to submit their assignments electronically. Professors usually set up specific assignment submission areas within Blackboard where students can upload their files or enter text-based responses.",
    },
    {
      question: "Can I communicate with my professors through Blackboard?",
      answer:
        "Yes, Blackboard offers communication tools such as email, discussion boards, and messaging features that allow students to interact with their professors. You can use these tools to ask questions, seek clarification, or engage in course-related discussions.",
    },
  ];
